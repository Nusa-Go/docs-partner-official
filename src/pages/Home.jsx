...
import { ShieldCheck, User, FileText, MessageSquare, ArrowRight, Search, ChevronDown, Building2, Car, Key, Sparkles, MapPin } from "lucide-react";
...
const FAQItem = ({ q, a, isOpen, onClick }) => (
  <div className="mb-4">
    <button
      onClick={onClick}
      className={`w-full flex items-center justify-between p-6 text-left transition-all duration-500 rounded-[2rem] border ${isOpen ? "bg-white border-primary/30 shadow-xl scale-[1.02]" : "bg-white border-slate-100 hover:border-primary/20 shadow-sm"
        }`}
    >
...
const Home = () => {
  ...
  return (
    <div className="bg-[#FDFDFD] min-h-screen antialiased overflow-x-hidden selection:bg-primary/10 selection:text-primary font-sans text-slate-900">

      {/* --- 1. HERO SECTION --- */}
      <section className="relative min-h-screen lg:h-[85vh] flex items-center overflow-hidden z-10 bg-white">

        {/* CLEAN SHAPED BACKGROUND - RED AREA */}
        <div
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative z-20 px-6 md:px-12">
          ...
          <div className="text-white space-y-7 text-center lg:text-left">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 justify-center lg:justify-start">
                ...
                <span className="text-[11px] font-extrabold tracking-[0.3em] uppercase text-white/60">Partner Hub</span>
              </div>

              <h1 className="text-5xl md:text-7xl font-extrabold tracking-[-0.04em] leading-[1.05] mb-6">
                Ada yang bisa <br />
                <span className="text-white/30 font-light italic">kami bantu?</span>
              </h1>
              <p className="text-base md:text-lg text-white/70 max-w-lg mx-auto lg:mx-0 font-medium leading-relaxed border-l-4 border-white/20 pl-6 text-left">
      ...
      <section className="py-20 bg-[#F8FDFA] font-sans">
        <div className="max-w-7xl mx-auto px-6">

          {/* Header Section */}
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-[-0.04em] mb-6">
              Mulai langkah <span className="text-primary italic font-medium">anda.</span>
            </h2>
            <p className="text-slate-400 font-semibold text-xs tracking-[0.4em] uppercase">
      ...
      <section className="py-16 md:py-20 px-6 max-w-7xl mx-auto relative lg:-mt-16">
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-[-0.04em] mb-6">
            Panduan <span className="text-primary font-medium">NusaGo partner</span>
          </h2>
          <p className="text-slate-400 font-semibold text-xs tracking-[0.3em] uppercase">Pusat bantuan & ekosistem digital</p>
        </div>
      ...
      <section className="py-12 md:py-16 bg-primary text-white w-full overflow-hidden font-sans border-y border-white/10">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-[-0.04em] leading-[1.1] text-white mb-6">
                Kelola bisnis dalam <br />
                <span className="text-white/40 font-light italic">ekosistem terpadu.</span>
              </h2>
            </div>

            <p className="text-white/50 font-semibold text-xs uppercase tracking-[0.2em] lg:text-right max-w-[280px] leading-relaxed">
      ...
      <section className="py-12 md:py-16 bg-white w-full overflow-hidden font-sans">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div className="space-y-3">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold tracking-[-0.04em] text-slate-900 leading-none mb-6">
                Tanya <span className="text-slate-300 italic font-medium">jawab.</span>
              </h2>
            </div>
            <p className="text-slate-400 font-semibold text-xs uppercase tracking-[0.2em] max-w-[200px] leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-3">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className={`group transition-all duration-500 rounded-3xl ${openFaq === idx ? "bg-slate-50 shadow-sm" : "bg-transparent hover:bg-slate-50/50"
                  }`}
              >
                <button
                ...
                >
                  <div className="flex items-center gap-6">
                    ...
                    <h3 className={`font-bold text-lg md:text-xl tracking-tight transition-all duration-500 ${openFaq === idx ? "text-primary" : "text-slate-800"
                      }`}>
                      {faq.q}
                    </h3>
                  </div>

                  <div className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-500 ${openFaq === idx
                ...
                <div className={`transition-all duration-500 ease-in-out overflow-hidden ${openFaq === idx ? "max-h-[300px] opacity-100" : "max-h-0 opacity-0"
                  }`}>
      ...
      <footer className="px-6 md:px-50 pb-12 font-sans">
